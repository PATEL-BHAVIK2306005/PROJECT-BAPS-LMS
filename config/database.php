...
return [
    ...
    */
    ...
    'default' => env('DB_ACTIVE_CONNECTION', env('DB_STATE', 'offline') === 'online' ? 'mysql_online' : env('DB_CONNECTION', 'mysql')),
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_online' => [
            ...
            'database' => env('DB_ONLINE_DATABASE', 'laravel'),
            'username' => env('DB_ONLINE_USERNAME', 'root'),
        ...
        'gcp' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_GCP_HOST', '127.0.0.1'),
            'port' => env('DB_GCP_PORT', '3306'),
            'database' => env('DB_GCP_DATABASE', 'gcp_db'),
            'username' => env('DB_GCP_USERNAME', 'root'),
            'password' => env('DB_GCP_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'itmbu_server' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_ITMBU_HOST', '127.0.0.1'),
            'port' => env('DB_ITMBU_PORT', '3306'),
            'database' => env('DB_ITMBU_DATABASE', 'itmbu_db'),
            'username' => env('DB_ITMBU_USERNAME', 'root'),
            'password' => env('DB_ITMBU_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'mongodb' => [
            ...
            'database' => env('DB_MONGODB_DATABASE', 'mongodb_db'),
