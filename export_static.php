...
$routes = [
    ...
    '/hub' => 'hub.html',
    '/admin/exam/schedule' => 'admin/exam/schedule.html',
    '/admin/exam/seating' => 'admin/exam/seating.html',
    '/admin/exam/forms' => 'admin/exam/forms.html',
    '/admin/exam/live-proctoring' => 'admin/exam/live-proctoring.html',
    '/admin/exam/results-grading' => 'admin/exam/results-grading.html',
    '/admin/exam/quiz-management' => 'admin/exam/quiz-management.html',
];
...
foreach ($routes as $uri => $outFile) {
    ...
    $urlMappings = [
        ...
        'href="/admin/exam/schedule"' => 'href="' . $repoPrefix . '/admin/exam/schedule.html"',
        'href="/admin/exam/seating"' => 'href="' . $repoPrefix . '/admin/exam/seating.html"',
        'href="/admin/exam/forms"' => 'href="' . $repoPrefix . '/admin/exam/forms.html"',
        'href="/admin/exam/live-proctoring"' => 'href="' . $repoPrefix . '/admin/exam/live-proctoring.html"',
        'href="/admin/exam/results-grading"' => 'href="' . $repoPrefix . '/admin/exam/results-grading.html"',
        'href="/admin/exam/quiz-management"' => 'href="' . $repoPrefix . '/admin/exam/quiz-management.html"',
        'href="/admin/exam"' => 'href="' . $repoPrefix . '/admin/exam/schedule.html"',
        'href="/admin/exams"' => 'href="' . $repoPrefix . '/admin/exam/schedule.html"',
